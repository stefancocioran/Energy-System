...
public class PriceStrategy {
  ...
  public PriceStrategy(Distributor distributorsDatabase,
  ...
  public void distribute() {
    if (distributor.getProducersId().isEmpty() && !distributor.getIsBankrupt()) {
      ...
      producers.sort((o1, o2) -> Comparator.comparing(EnergyProducer::getPriceKW).reversed()
          .thenComparing(EnergyProducer::getEnergyPerDistributor).reversed().compare(o1, o2));
